...
class LoginScreenTest {
     ...
     * At UI level we use Espresso(For view-based screen), ComposeTest(foor JetpackCompose Screen) or UiAtomator for SystemLevel Assertions(like permission dialogs, browser assertions etc.)
